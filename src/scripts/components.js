...
class ComponentLoader {
  ...
  async loadComponent(componentName, targetElement) {
    ...
    try {
      ...
      let componentPath;
      if (isMainPage) {
        componentPath = `src/components/${componentName}-main.html`;
      } else {
        componentPath = `../src/components/${componentName}.html`;
      }
      ...
      this.loadFallbackComponent(componentName, targetElement, isMainPage);
    }
  }

  // Load fallback component if file loading fails
  loadFallbackComponent(componentName, targetElement, isMainPage = false) {
                    ...
                    <header>
                        <div class="header-container">
                            <a href="${basePath}index.html" class="logo-link">
                                <img src="${basePath}images/racingLogo.png" alt="Racing de Santander Crest" class="logo">
                            </a>
                            <nav class="main-nav">
                                <ul>
                                    <li><a href="${basePath}index.html" id="nav-home">HOME</a></li>
                                    <li><a href="${basePath}pages/squad.html" id="nav-squad">SQUAD</a></li>
                                    <li><a href="${basePath}pages/history.html" id="nav-history">HISTORY</a></li>
                                </ul>
                            </nav>
                    ...
                    <footer>
                        <div class="footer-container">
                            <div class="footer-column">
                                <img src="${basePath}images/racingLogo.png" alt="Racing de Santander Crest" class="logo-footer">
                            ...
                            <div class="footer-column">
                                ...
                                <ul>
                                    ...
                                    <li><a href="${basePath}pages/squad.html">Squad</a></li>
